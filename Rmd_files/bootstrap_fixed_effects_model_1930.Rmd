...
```{r}
DT <-read_fst(here(paste0("output/Rdata/census_sample_1930_individual_data_x_countynhg_1910.fst")),as.data.table=TRUE)[occ1950_main!=979 & ind1950_main!=0 & perwt_1930 > 10000][,c("countynhg_1910","perwt_1930","sh_red_tit","occind","statefip","urban","male","lit","marst","race","wwages","mig_us","mig_ab","age_main","ind1950","ind1950_main","famsize","ownershp","m_mig_us","f_mig_us")][!is.na(lit)][order(countynhg_1910,occind)][!(age_main<=1)]
```
