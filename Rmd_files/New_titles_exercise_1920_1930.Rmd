...
```{r}
census_sample_1930_individual_data <-read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1930_individual_data_x_countynhg_1910.fst",as.data.table=TRUE)
```
...
```{r}
census_sample_1930_individual_data <-read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1930_individual_data_x_metarea_1940.fst",as.data.table=TRUE)
```
...
# With/without ind1950_main
  ...
  # Different new sector variable
    ...
    # Different industry variable
      a[[j]] <- as.formula(paste("sh_red_tit ",i2,paste0(base_individual,collapse=" + "),i1," sh_lit_1920 + log(perwt_1920) + H_1920",i3))
      j <- j + 1
    }
  }
}
  ...
  # Different new sector variable
    ...
    # With/without industry variable
      ...
      # different occ share variables
        b[[j]] <- as.formula(paste("sh_red_tit ",i2,paste0(base_individual,collapse=" + "),i1," sh_lit_1920 + log(perwt_1920) + H_1920 ",i3,paste0(" + sh_occ1950_main_",i4,"_1920")))
        j <- j + 1
      }
      b[[j]] <- as.formula(paste("sh_red_tit ",i2,paste0(base_individual,collapse=" + "),i1," sh_lit_1920 + log(perwt_1920) + H_1920 ",i3,paste0(" + sh_occ1950_main_500_1920 + sh_occ1950_main_600_1920")))
      j <- j + 1
    }
  }
}
...
#write.xlsx(coef[(variable=="coef_star" | variable =="std_par" | variable=="zother"),c("rn",c(paste0("model_",c(1:4))))],"/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Tables/ind_reg_1930_sh_red_tit_by_sh_occ1950_main_countynhg_1910.xlsx",row.names = FALSE)
wrapper_Excel(list( coef.all, coef.no_new_all,coef.no_new_serv,coef.no_new_all_different_occsh,coef.new_sector_x_sh_occ,coef.positive_sh_new_sec_1920,coef.positive_sh_new_sec_1930
              ...
              "/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Tables/ind_reg_1930_countynhg_1910_robustness_occsh_problem.xlsx")
...
census_sample_new_sectors_occsh_1920 <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/input/census_sample/census_sample_1920.fst",as.data.table=TRUE)[,c("perwt","ind1950","occ1950")]
...
for (i in grep("^sh_occ1950_.+_1920",names(census_sample_new_work_x_new_sectors),value=TRUE) ) {
  ...
  corr_2[j] <- cor(census_sample_1930_individual_data$new_sec_all_1920,
                  ...
                  use="complete.obs", method = c("pearson"))
  corr_3[j] <- cor(census_sample_new_work_x_new_sectors$sh_red_tit_1930, 
                   census_sample_new_work_x_new_sectors[,c(eval(parse(text=paste0(i))))], 
                   use="complete.obs", method = c("pearson"))
  corr_4[j] <- cor(census_sample_1930_individual_data$sh_red_tit,
                  census_sample_1930_individual_data[,c(eval(parse(text=paste0(i))))],
                  use="complete.obs", method = c("pearson"))
  ...
  corr_p2[j] <- wtd.cors(census_sample_new_work_x_new_sectors$sh_red_tit_1930, 
                   census_sample_new_work_x_new_sectors[,c(eval(parse(text=paste0(i))))],
                   weight=census_sample_new_work_x_new_sectors$perwt_1930)
  j <- j+1
}
...
wrapper_Excel(list( reg.all, reg.all_weights_1920, reg.all_weights_1930,reg.main, reg.main_weights_1920, reg.main_weights_1930,reg.serv, reg.serv_weights_1920, reg.serv_weights_1930
              ...
              "/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Tables/ind_reg_1930_countynhg_1910_robustness_new_sec_x_occsh.xlsx")
...
## Calling the aggregate data to constructs information without workers in new sectors
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1930_individual_data.fst",as.data.table=TRUE)[occ1950_main!=979 & ind1950_main!=0 & !(ind1950 %in% c(376,377,466,556,606,667,668,816,856)),c("metarea_1940","perwt_ID","ind1950","ind1950_main","occ1950_main","sh_red_tit","sh_base_tit")]
...
```{r}
# 1930
census_sample_1930_countynhg_1910 <-read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1930_agg_countynhg_1910.fst",as.data.table=TRUE)
...
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1930_agg_countynhg_1910_no_new_sec_all.fst",as.data.table=TRUE)
...
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1930_agg_countynhg_1910_no_new_sec_main.fst",as.data.table=TRUE)
cols <- grep("^countynhg_1910|^sh_ind1950|^sh_occ|^sh_base|^sh_red|^sh_race|^sh_male|^sh_lit|^H|^perwt",names(temp),value=TRUE)
temp <- temp[,cols,with=FALSE]
cols <- names(temp[,!c("countynhg_1910")])
...
# 1920
temp <-read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1920_agg_countynhg_1910.fst",as.data.table=TRUE)
...
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1920_agg_countynhg_1910_no_new_sec_all.fst",as.data.table=TRUE)
cols <- grep("^countynhg_1910|^sh_ind1950|^sh_occ|^sh_base|^sh_red|^sh_race|^sh_male|^sh_lit|^H|^perwt",names(temp),value=TRUE)
temp <- temp[,cols,with=FALSE]
cols <- names(temp[,!c("countynhg_1910")])
...
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1920_agg_countynhg_1910_no_new_sec_main.fst",as.data.table=TRUE)
cols <- grep("^countynhg_1910|^sh_ind1950|^sh_occ|^sh_base|^sh_red|^sh_race|^sh_male|^sh_lit|^H|^perwt",names(temp),value=TRUE)
temp <- temp[,cols,with=FALSE]
cols <- names(temp[,!c("countynhg_1910")])
...
for (i1 in c("sh_red_tit_1930_no_new_sec_all","sh_red_tit_1930_no_new_sec_main")) {
  for (i2 in c(1,2,3)) {
    j <- 1
    for (i3 in c(
      paste0(""),
      ...
      for (i4 in c(
        ...
        } else if (i1=="sh_red_tit_1930_no_new_sec_main" & (i2==1)) {
          c[[j]] <- as.formula(paste(i1," ~ new_sec_main_1920",i3,i4))
        } else if (i1=="sh_red_tit_1930_no_new_sec_main" & (i2==3)) {
...
# sh_red_tit using only no new sector workers
...
# sh_red_tit using only no new sector main workers
...
# sh_red_tit using only no new sector workers + WEIGHTS
...
wrapper_Excel(list(
            ...
            "/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Tables/regional_reg_1930_ctynhg_1910.xlsx")
...
wrapper_Excel(list(
            ...
            "/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Tables/regional_reg_1930_ctynhg_1910_occsh_exercise.xlsx")
...
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/estimation.bootstrap.perwtge_10000.nostatefe_noindmain.fst",as.data.table=TRUE)
...
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/estimation.bootstrap.perwtge_10000.nostatefe_with_indmain.fst",as.data.table=TRUE)
...
wrapper_Excel(list(
            ...
            "/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Tables/two_stage_regional_reg_1930_ctynhg_1910.xlsx")
...
```{r}
# 1930
correlations_data_1880_to_1930_countynhg_1910 <-read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1930_agg_countynhg_1910.fst",as.data.table=TRUE)
...
#1910
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1910_agg_countynhg_1910.fst",as.data.table=TRUE)
...
#1900
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1900_agg_countynhg_1910.fst",as.data.table=TRUE)
...
#1880
temp <- read_fst("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Rdata/census_sample_1880_agg_countynhg_1910.fst",as.data.table=TRUE)
cols <- names(temp[,!c("countynhg_1910")])
...
ggarrange(p[[1]],p[[2]],p[[3]],labels=c("All New Sectors","Main New Sectors","Service New Sectors"),
          ncol=2,nrow=2)
ggsave("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_new_sectors_1920_x_1930.jpeg",plot=last_plot())
...
ggarrange(p[[1]],p[[2]],p[[3]],labels=c("All New Sectors","Main New Sectors","Service New Sectors"),
          ncol=2,nrow=2)
ggsave("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_new_sectors_1910_x_1920.jpeg",plot=last_plot())
...
ggarrange(p[[1]],p[[2]],p[[3]],labels=c("All New Sectors","Main New Sectors","Service New Sectors"),
          ncol=2,nrow=2)
ggsave("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_new_sectors_1910_x_1930.jpeg",plot=last_plot())
  ...
  for (var_x in c(1880,1900,1910,1920)) {
    if (var_x < var_y) {
      ...
      ggarrange(p[[1]],p[[2]],p[[3]],p[[4]],labels=c("Agriculture","Mining and Construction","Manufacturing","Trans., Comm., other Util."),
                ncol=2,nrow=2)
      ggsave(paste0("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_main_ind1950_",var_x,"_x_",var_y,"_1.jpeg"),plot=last_plot())
      ggarrange(p[[5]],p[[6]],p[[7]],labels=c("Trade","Services","Public Administration"),
                ncol=2,nrow=2)
      ggsave(paste0("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_main_ind1950_",var_x,"_x_",var_y,"_2.jpeg"),plot=last_plot())
    }
  }
}
```
...
for (var_y in c(1930,1920,1910)) {
  for (var_x in c(1880,1900,1910,1920)) {
    if (var_x < var_y) {
      ...
      ggsave(paste0("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_main_occ1950_",var_x,"_x_",var_y,"_1.jpeg"),plot=last_plot())
      ggarrange(p[[5]],p[[6]],p[[7]],p[[8]],labels=c("Sales workers","Craftsmen","Operatives","Service Workers (private household)"),
                ncol=2,nrow=2)
      ggsave(paste0("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_main_occ1950_",var_x,"_x_",var_y,"_2.jpeg"),plot=last_plot())
      ggarrange(p[[9]],p[[10]],p[[11]],labels=c("Service Workers (not household)","Farm laborers","Laborers"),
                ncol=2,nrow=2)
      ggsave(paste0("/Users/mauribev/Google Drive/New York 2015-2020/NYU/Year 4/Data Manuals/Alphabetical Index of Occupations and Industries/Occupational Title Lists - READY/R - Processing data/output/Graphs/countynhg_1910/corr_sh_main_occ1950_",var_x,"_x_",var_y,"_3.jpeg"),plot=last_plot())
    }
  }
}
```
