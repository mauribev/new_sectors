...
```{r}
# Basic
m1 <- lm(sh_new_method1 ~ log(perwt) + sh_race_1 + sh_race_2 + sh_lit + sh_urban + sh_farm + sh_mig_us + sh_mig_ab, data=census_sample_1940_agg_countynhg_1910)
m2 <- lm(sh_new_method1 ~ log(perwt) + sh_race_1 + sh_race_2 + sh_lit + sh_urban + sh_farm + sh_mig_us + sh_mig_ab + statefip , data=census_sample_1940_agg_countynhg_1910)
...
```{r}
# Basic
m1 <- lm(sh_new_method1 ~ log(perwt) + sh_race_1 + sh_race_2 + sh_lit + sh_urban + sh_farm + sh_mig_us + sh_mig_ab, data=census_sample_1940_agg_metarea_1940)
m2 <- lm(sh_new_method1 ~ log(perwt) + sh_race_1 + sh_race_2 + sh_lit + sh_urban + sh_farm + sh_mig_us + sh_mig_ab, data=census_sample_1940_agg_metarea_1940[MSA=="Non MSAs"])
m3 <- lm(sh_new_method1 ~ log(perwt) + sh_race_1 + sh_race_2 + sh_lit + sh_urban + sh_farm + sh_mig_us + sh_mig_ab, data=census_sample_1940_agg_metarea_1940[MSA=="MSAs"])
...
#new_title_location.metarea_1940 <- new_title_location.metarea_1940[,perwt:=sum(perwt_sum),by=c("metarea_1940")][,c("perwt","sh_base","sh_base_tit","sh_base_titind","sh_red","sh_new_method1","sh_new_method1ind"):=lapply(.SD,weighted.mean,w=perwt_sum),by=c("metarea_1940"),.SDcols=c("perwt_sum","sh_new_all_dataset1","sh_new_all_dataset2","sh_new_all_dataset3","sh_new_method1_dataset1","sh_new_method1_dataset2","sh_new_method1_dataset3","sh_new_method2_dataset1","sh_new_method2_dataset2","sh_new_method2_dataset3")]

```
***NOT/TO-DO:*** REVIEWWWWW!!!!!
...
census_sample_1930_individual_data <- 
  read_fst(here(paste0("output/Rdata/census_sample_1930_individual_data.fst")),as.data.table=TRUE,columns=c("countynhg_1910","statefip","perwt_ID","ind1950","ind1950_main","occind","occ1950","occ1950_main","sh_new_method1","sh_new_method2","empstat","classwkr","age"))[occ1950_main!=979 & ind1950_main!=0 & (empstat==1 |classwkr==1 | classwkr==2) & (age>=16 & age <=64)][,.(perwt=sum(perwt_ID)),by=c("countynhg_1910","statefip","ind1950","ind1950_main","occind","occ1950","occ1950_main","sh_new_method1")]
...
census_sample_1930_countynhg_1910_data <-
  read_fst(here(paste0("output/Rdata/census_sample_1930_agg_countynhg_1910.fst")),as.data.table=TRUE,columns=c("countynhg_1910","perwt","sh_new_all","sh_new_method1","sh_new_method2"))[!is.na(countynhg_1910)]
...
census_sample_1930_individual_data <- 
  merge(
    read_fst(here(paste0("output/Rdata/census_sample_1930_individual_data.fst")),as.data.table=TRUE,columns=c("perwt_ID","countynhg_1910","occind","sh_new_method1","ind1950")),
...
new_titles.occind1930 <- read_fst(here(paste0("output/Rdata/new_titles_1930_by_occind.fst")),as.data.table=TRUE)
...
```{r}
#
census_sample_1930_grouped_occ <- census_sample_1930_individual_data[perwt>=10000][,.(perwt=sum(perwt_ID)),by=c("occind","sh_new_method1")]
...
Table_new_titles <- data.table(
  ...
  '1930'=c(
                  ...
                  format(round(mean(census_sample_1930_grouped_occ$sh_new_method1),2),nsmall=2),
                  format(round(sd(census_sample_1930_grouped_occ$sh_new_method1),2),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_grouped_occ$sh_new_method1)),2),nsmall=2)
  ),
  '1940 - Dt2'=c(
  ...
  '1930 People'=c(
                  nrow(census_sample_1930_grouped_occ),
                  round(weighted.mean(census_sample_1930_grouped_occ$sh_new_method1,census_sample_1930_grouped_occ$perwt,na.rm=TRUE),2),
                  round(sqrt(wtd.var(census_sample_1930_grouped_occ$sh_new_method1,census_sample_1930_grouped_occ$perwt,na.rm=TRUE)),2),
                  round(unname(wtd.quantile(census_sample_1930_grouped_occ$sh_new_method1,census_sample_1930_grouped_occ$perwt,na.rm=TRUE)),2)
  ),
  '1940 People - Dt2'=c(
                  nrow(census_sample_1940_grouped_occ_dt2),
...
Table <- data.table(
  ...
  '1930 - Individuals'=c(
                  ...
                  format(round(mean(census_sample_1930_individual_data[perwt>=10000]$sh_new_method1),4),nsmall=2),
                  format(round(sd(census_sample_1930_individual_data[perwt>=10000]$sh_new_method1),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_individual_data[perwt>=10000]$sh_new_method1)),4),nsmall=2)
  ),
  '1930 - Counties'=c(
                  nrow(census_sample_1930_countynhg_1910_data[perwt>=10000]),
                  format(round(mean(census_sample_1930_countynhg_1910_data[perwt>=10000]$sh_new_method1),4),nsmall=2),
                  format(round(sd(census_sample_1930_countynhg_1910_data[perwt>=10000]$sh_new_method1),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_countynhg_1910_data[perwt>=10000]$sh_new_method1)),4),nsmall=2)
  ),
...
g_1930_countynhg_1910 <-
  ggplot(census_sample_1930_countynhg_1910_data[perwt>=10000][,c("sh_new_method1")], aes(x=sh_new_method1)) +
        geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
        geom_vline(data=census_sample_1930_countynhg_1910_data[,.(sh_new_method1=mean(sh_new_method1,na.rm=TRUE))],aes(xintercept=sh_new_method1),
                   linetype="dashed") + 
...
# Individuals
g_1930_individuals <-
  ggplot(census_sample_1930_individual_data[perwt>=10000][,c("sh_new_method1")], aes(x=sh_new_method1)) +
        geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
        geom_vline(data=census_sample_1930_individual_data[,.(sh_new_method1=mean(sh_new_method1,na.rm=TRUE))],aes(xintercept=sh_new_method1),
                   linetype="dashed") + 
        scale_y_continuous(labels = percent_format()) +
        labs(title="",x="", y = "Share of people")  + 
        theme_tufte()
...
# Occupations
g_1930_occ <-
  ggplot(census_sample_1930_grouped_occ[,c("sh_new_method1")], aes(x=sh_new_method1)) +
          geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
          geom_vline(data=census_sample_1930_grouped_occ[,.(sh_new_method1=mean(sh_new_method1,na.rm=TRUE))],aes(xintercept=sh_new_method1),
                     linetype="dashed") + 
          scale_y_continuous(labels = percent_format()) +
...
x_min <- -0.05 +min(
             min(census_sample_1930_individual_data[perwt>=10000][,c("sh_new_method1")]$sh_new_method1),
             min(census_sample_1940_individual_data[perwt>=10000][,c("sh_new_method1_dataset2")]$sh_new_method1_dataset2)
           )
x_max <- max(
             max(census_sample_1930_individual_data[perwt>=10000][,c("sh_new_method1")]$sh_new_method1),
...
```{r}
A_1930 <- census_sample_1930_individual_data[perwt>=10000][,.(perwt=sum(perwt_ID),sh_0=sum(perwt_ID*(sh_new_method1<=0.0001)),mean=mean(sh_new_method1,na.rm=TRUE),q25=quantile(sh_new_method1,na.rm=TRUE)[2],q75=quantile(sh_new_method1,na.rm=TRUE)[4],q80=quantile(sh_new_method1,probs=c(0.8),na.rm=TRUE),q90=quantile(sh_new_method1,probs=c(0.9),na.rm=TRUE),q95=quantile(sh_new_method1,probs=c(0.95),na.rm=TRUE),q99=quantile(sh_new_method1,probs=c(0.99),na.rm=TRUE)),by="countynhg_1910"][,sh_0:=sh_0/perwt]
...
Table_1930_occ <- 
  merge(
    census_sample_1930_individual_data[perwt>=10000 & !is.na(sh_new_method1)],
...
table_ind <- 
    f_ind_new_titles(Table_1930_occ,id_N=5,var=occind,w_v=perwt_ID,sh_v=sh_new_method1,cols_v=ind1950)
col <- grep("^sh_ind1950|^emp|^sh_new_method1",names(table_ind),value=TRUE)
table_ind <- table_ind[,!..col]

table_countynhg_1910 <- 
    f_ind_new_titles(Table_1930_occ,id_N=5,var=occind,w_v=perwt_ID,sh_v=sh_new_method1,cols_v=countynhg_1910)
col <- grep("^sh_ind1950|^emp|^sh_new_method1",names(table_countynhg_1910),value=TRUE)
table_countynhg_1910 <- table_countynhg_1910[,!..col]

# Compiling the whole table
Table_1930_occ <- Table_1930_occ[,.(occind1930_name=occind1930_name[1],sh_new_method1=sh_new_method1[1],perwt=sum(perwt_ID),n_red_tit=n_red_tit[1]),by=c("occind")][,sh_perwt:=sum(perwt)][,`:=`(sh_perwt=perwt/sh_perwt)][,perwt_red_tit:=perwt*sh_new_method1]
setcolorder(Table_1930_occ,c("occind","occind1930_name","sh_new_method1","perwt_red_tit","perwt","sh_perwt"))
...
# Compiling the whole table
Table_1940_occ_dt2 <- Table_1940_occ_dt2[,.(name_ind1940_subgroup=name_ind1940_subgroup[1],sh_new_method1_dataset2=sh_new_method1_dataset2[1],perwt=sum(perwt_ID),N_dataset2=N_dataset2[1],N_red_inv_dataset2=N_red_inv_dataset2[1],count=count[1]),by=c("occ1940","occ1940_subocc_method1_dataset2")][,sh_perwt:=sum(perwt)][,`:=`(sh_perwt=perwt/sh_perwt)][,perwt_new_method1_dataset2:=perwt*sh_new_method1_dataset2][count>1,name_ind1940_subgroup:=NA]
setcolorder(Table_1940_occ_dt2,c("occ1940","occ1940_subocc_method1_dataset2","name_ind1940_subgroup","sh_new_method1_dataset2","perwt_new_method1_dataset2","perwt","sh_perwt"))
...
ggplot(Table_1940_occ_dt2, aes(y=H_countynhg_1910, x=sh_new_method1_dataset2)) + 
  geom_point(size=0.1) + geom_rangeframe()  +  stat_smooth(method="lm", se=TRUE) 

ggplot(Table_1930_occ, aes(y=H_countynhg_1910, x=sh_new_method1)) + 
  geom_point(size=0.1) + geom_rangeframe()  +  stat_smooth(method="lm", se=TRUE) 

ggplot(Table_1940_occ_dt2, aes(y=H_countynhg_1910, x=log(perwt_new_method1_dataset2))) + 
  geom_point(size=0.1) + geom_rangeframe()  +  stat_smooth(method="lm", se=TRUE) 
...
g_1930_occ <-
  ggplot(Table_1940_occ_dt2[,c("H_countynhg_1910")], aes(x=sh_new_method1)) +
          geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
          geom_vline(data=census_sample_1930_grouped_occ[,.(sh_new_method1=mean(sh_new_method1,na.rm=TRUE))],aes(xintercept=sh_new_method1),
                     linetype="dashed") + 
          scale_y_continuous(labels = percent_format()) +
...
!!!!! NOTE: The share of new sectors in 1930 should be rerun using sh_new_method1ind
## Loading packages and erasing the workspace (make sure to have loaded f_load_pk)
```{r}
rm(list = setdiff(ls(),c(lsf.str(),"main_directory") ))
f_load_pk()
...
## No new sec all
temp <- 
  read_fst(paste0(main_directory,"R - Processing data/output/Rdata/new_titles_agg_no_new_sec_all.fst"),as.data.table=TRUE,columns=c("countynhg_1910","perwt","sh_new_method1","sh_new_method1ind"))[!is.na(countynhg_1910)][,lapply(.SD,weighted.mean,w=perwt),by=c("countynhg_1910"),.SDcols=c("sh_new_method1","sh_new_method1ind")]
col <- names(temp[,!c("countynhg_1910")])
...
## No new sec main
temp <- 
  read_fst(paste0(main_directory,"R - Processing data/output/Rdata/new_titles_agg_no_new_sec_main.fst"),as.data.table=TRUE,columns=c("countynhg_1910","perwt","sh_new_method1","sh_new_method1ind"))[!is.na(countynhg_1910)][,lapply(.SD,weighted.mean,w=perwt),by=c("countynhg_1910"),.SDcols=c("sh_new_method1","sh_new_method1ind")]
col <- names(temp[,!c("countynhg_1910")])
...
- sh_new_method1                        x new_sec_all_1920, new_sec_main_1920
- sh_new_method1_no_new_sec_all         x new_sec_all_1920, new_sec_main_1920
- sh_new_method1_no_new_sec_main        x new_sec_all_1920, new_sec_main_1920
...
# 1920 - 1930
#****!!! NOTE, TO-DO: Need also to include "sh_new_method1ind_1930". This one is part of 
...
for (pop in c(10000)) {
  for (workers in c("no_new_sec","all")) {
    for(cov in c("base","base.extra","base.extra.other","base.extra.other.educ","base.extra.other.educ.ind1950","base.extra.other.ind1950")) {
      temp <- read_fst(paste0(main_directory,"R - Processing data/output/Rdata/coef_final_1930_method_sh_new_method1.btrap.perwtge_",pop,".",cov,".",workers,".fst"),as.data.table=TRUE,columns = c("rn","coef.b","se.b"))
      ...
      setnames(
        ...
        c("coef.b","se.b","weights"),
        c(
          paste0("fe.method_","sh_new_method1",".perwtge_",pop,".",cov,".",workers),
          paste0("se.method_","sh_new_method1",".perwtge_",pop,".",cov,".",workers),
          paste0("weights.method_","sh_new_method1",".perwtge_",pop,".",cov,".",workers)
        )
      )
      rm(temp)
    }
  ...
  for (method in c(1)) {
    for (dt in c(2,3)) {
      for (cov in c("base","base.extra","base.extra.other","base.extra.other.educ","base.extra.other.educ.ind1950","base.extra.other.ind1950")) {
        ...
        pop <- 10000
        setnames(fe_1930,
                 c(paste0(c("fe.","se.","weights."),paste0("method_sh_new_method1",".perwtge_",pop,".",cov,".",workers))),
                 c("fe","se","wt")
        )
        setnames(fe_1940,
...
# Simplify ----
census_sample_1930_main <-
  census_sample_1930_main[,.(perwt=sum(perwt_ID),sh_new_method1=mean(sh_new_method1)),by=c("occind","countynhg_1910","lit","statefip","urban","male","race","wwages","mig_us","mig_ab","age_main","ind1950","ind1950_main")]
...
census_sample_1930_industry_study <- 
  merge(
    census_sample_1930_main[,.(perwt=sum(perwt),sh_new_method1=weighted.mean(sh_new_method1,w=perwt)),by=c("ind1950","ind1950_main")][,n_new_work:=perwt*sh_new_method1],
...
cat(gsub(pattern = "\n", replacement = "  \n", 
         x = paste0(
           ...
           format(round(mean(census_sample_1930_industry_study$sh_new_method1),4),nsmall=2),
           "\nand the standard deviation: ",
           format(round(sd(census_sample_1930_industry_study$sh_new_method1),4),nsmall=2),
           "\n\n"
         )
))

## Some graphs
ggplot(census_sample_1930_industry_study, aes(x=sh_new_method1)) +
...
## Table
knitr::kable(census_sample_1930_industry_study[order(-sh_new_method1,-perwt),c("ind1950_name","sh_new_method1","perwt","n_new_work")][1:15])
knitr::kable(census_sample_1930_industry_study[order(-sh_new_method1,-perwt),c("ind1950_name","sh_new_method1","perwt","n_new_work")][16:30])

# ind1950_main ----
census_sample_1930_industry_study_all <- 
  merge(
    census_sample_1930_industry_study[,.(perwt=sum(perwt),sh_new_method1=weighted.mean(sh_new_method1,w=perwt)),by=c("ind1950_main")][,n_new_work:=perwt*sh_new_method1],
...
census_sample_1930_industry_study_no_new_sec <- 
  merge(
    census_sample_1930_industry_study[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))  ,.(perwt=sum(perwt),sh_new_method1=weighted.mean(sh_new_method1,w=perwt)),by=c("ind1950_main")][,n_new_work:=perwt*sh_new_method1],
    data.table(ind1950_main=c(1:7),ind1950_main_name=c("Agriculture","Mining and Construction","Manufacturing","Transportation, Communication, and Other Utilities","Trade","Services","Public Administration")),
    by="ind1950_main",all.x=TRUE,all.y=FALSE
  )
...
cat(gsub(pattern = "\n", replacement = "  \n", 
         x = paste0(
           ...
           format(round(mean(census_sample_1930_industry_study_all$sh_new_method1),4),nsmall=2),
           "\nand the standard deviation: ",
           format(round(sd(census_sample_1930_industry_study_all$sh_new_method1),4),nsmall=2),
           "\n\n"
         )
))
cat(gsub(pattern = "\n", replacement = "  \n", 
         x = paste0(
           ...
           format(round(mean(census_sample_1930_industry_study_no_new_sec$sh_new_method1),4),nsmall=2),
           "\nand the standard deviation: ",
           format(round(sd(census_sample_1930_industry_study_no_new_sec$sh_new_method1),4),nsmall=2)
         )
))
...
## Table
knitr::kable(census_sample_1930_industry_study_all[order(-sh_new_method1,-perwt),c("ind1950_main_name","sh_new_method1","perwt","n_new_work")],caption="All workers")
knitr::kable(census_sample_1930_industry_study_no_new_sec[order(-sh_new_method1,-perwt),c("ind1950_main_name","sh_new_method1","perwt","n_new_work")],caption="Excluding New sectors")
...
census_sample_1930_occ_study_all <- 
  merge(
    census_sample_1930_main[,occind_subind:=format(round(sh_new_method1,4),nsmall=2)][,.(perwt=sum(perwt),sh_new_method1=weighted.mean(sh_new_method1,w=perwt)),by=c("occind","occind_subind")][,n_new_work:=perwt*sh_new_method1],
...
census_sample_1930_occ_study_no_new_sec <- 
  merge(
    census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))][,occind_subind:=format(round(sh_new_method1,4),nsmall=2)][,.(perwt=sum(perwt),sh_new_method1=weighted.mean(sh_new_method1,w=perwt)),by=c("occind","occind_subind")][,n_new_work:=perwt*sh_new_method1],
    occ1930.codes[,c("occind","occind1930_name")],
    by="occind",all.x=TRUE,all.y=FALSE
...
Tab_1930 <- data.table(
  ...
  'All Workers'=c(
                  ...
                  format(round(mean(census_sample_1930_main$sh_new_method1),4),nsmall=2),
                  format(round(sd(census_sample_1930_main$sh_new_method1),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_main$sh_new_method1)),4),nsmall=2)
  ),
  'No New Sectors' = c(
                  ...
                  format(round(mean(census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))]$sh_new_method1),4),nsmall=2),
                  format(round(sd(census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))]$sh_new_method1),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))]$sh_new_method1)),4),nsmall=2)
  ),
  'All Workers - Gruped by occ'=c(
                  NA,
                  length(unique(census_sample_1930_occ_study_all$occind)),
                  format(round(mean(census_sample_1930_occ_study_all$sh_new_method1),4),nsmall=2),
                  format(round(sd(census_sample_1930_occ_study_all$sh_new_method1),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_occ_study_all$sh_new_method1)),4),nsmall=2)
  ),
  'No New Sectors - Grouped by occ' = c(
                  NA,
                  length(unique(census_sample_1930_occ_study_no_new_sec$occind)),
                  format(round(mean(census_sample_1930_occ_study_no_new_sec$sh_new_method1),4),nsmall=2),
                  format(round(sd(census_sample_1930_occ_study_no_new_sec$sh_new_method1),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_occ_study_no_new_sec$sh_new_method1)),4),nsmall=2)
  )
)
...
## Common Axis
x_min <- -0.05 +min(
             min(census_sample_1930_occ_study_all$sh_new_method1),
             min(census_sample_1930_occ_study_no_new_sec$sh_new_method1)
           )
x_max <- max(
             max(census_sample_1930_occ_study_all$sh_new_method1),
             max(census_sample_1930_occ_study_no_new_sec$sh_new_method1)
           )
## Graph
ggarrange(
  ggplot(census_sample_1930_occ_study_all, aes(x=sh_new_method1)) +
        geom_histogram(color="black",bins=40,  aes(y = stat(width*density)),  fill="white") +
        geom_vline(data=census_sample_1930_occ_study_all[,.(sh_new_method1=mean(sh_new_method1))],aes(xintercept=sh_new_method1),
           linetype="dashed") + 
        scale_y_continuous(labels = percent_format()) +
  ...
  ggplot(census_sample_1930_occ_study_no_new_sec, aes(x=sh_new_method1)) +
        geom_histogram(color="black",bins=40,  aes(y = stat(width*density)),  fill="white") +
        geom_vline(data=census_sample_1930_occ_study_no_new_sec[,.(sh_new_method1=mean(sh_new_method1))],aes(xintercept=sh_new_method1),
           linetype="dashed") +
        scale_y_continuous(labels = percent_format()) +
        scale_x_continuous(limits=c(x_min, x_max)) +
...
x_min <- -0.05 +min(
             min(census_sample_1930_main$sh_new_method1),
             min(census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))]$sh_new_method1)
           )
x_max <- max(
             max(census_sample_1930_main$sh_new_method1),
             max(census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))]$sh_new_method1)
           )

## Graph
ggarrange(
  ggplot(census_sample_1930_main, aes(x=sh_new_method1)) +
        geom_histogram(color="black",bins=40,  aes(y = stat(width*density)),  fill="white") +
        geom_vline(data=census_sample_1930_main[,.(sh_new_method1=mean(sh_new_method1))],aes(xintercept=sh_new_method1),
           linetype="dashed") + 
        scale_y_continuous(labels = percent_format()) +
        scale_x_continuous(limits=c(x_min, x_max)) +
        labs(title="",x="", y = "Share of people")  + 
  ...
  ggplot(census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))], aes(x=sh_new_method1)) +
        geom_histogram(color="black",bins=40,  aes(y = stat(width*density)),  fill="white") +
        geom_vline(data=census_sample_1930_main[!(ind1950 %in% c(376,377,466,556,606,667,668,816,856))][,.(sh_new_method1=mean(sh_new_method1))],aes(xintercept=sh_new_method1),
           linetype="dashed") +
        scale_y_continuous(labels = percent_format()) +
        scale_x_continuous(limits=c(x_min, x_max)) +
        labs(title="",x="Share of New Work", y = "Share of people")  + 
...
## Table
census_sample_1930_occ_study_all[order(-sh_new_method1,-perwt),c("occind1930_name","occind","sh_new_method1","perwt","n_new_work")][1:15] %>%
  kbl(caption = "Occupations and their associated New Work Share in 1930 (1 to 15)") %>%
  kable_classic(full_width = F, html_font = "Cambria")

census_sample_1930_occ_study_all[order(-sh_new_method1,-perwt),c("occind1930_name","occind","sh_new_method1","perwt","n_new_work")][16:30] %>%
...
for (var in c("race","age_main","urban","mig_ab","lit","ind1950_main")) {
  ...
  A <- census_sample_1930_main[,c("perwt","sh_new_method1","var","occind")]
    ...
    Tab <- merge(
        ...
        data.table(
          ...
          V1=c(
            ...
            format(round(mean(Temp$sh_new_method1),4),nsmall=2),
            format(round(sd(Temp$sh_new_method1),4),nsmall=2),
            format(round(unname(quantile(Temp$sh_new_method1)),4),nsmall=2)
          )
        )
    )
