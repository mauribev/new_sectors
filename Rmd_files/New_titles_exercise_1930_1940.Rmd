...
```{r}
new_title_1940_location.countynhg_1910_more1000 <- read_fst(paste0(main_directory,"R - Processing data/output/Rdata/census_sample_1940_agg_countynhg_1910.fst"),as.data.table=TRUE,columns=c("countynhg_1910","perwt","sh_new_method1_dataset1","sh_new_method1_dataset2","sh_new_method1_dataset3"))[perwt>=1000 & !is.na(countynhg_1910)]

new_title_1940_location.countynhg_1910_more10000 <- read_fst(paste0(main_directory,"R - Processing data/output/Rdata/census_sample_1940_agg_countynhg_1910.fst"),as.data.table=TRUE,columns=c("countynhg_1910","perwt","sh_new_method1_dataset1","sh_new_method1_dataset2","sh_new_method1_dataset3"))[perwt>=10000 & !is.na(countynhg_1910)]
...
```{r}
new_titles_agg <- read_fst(paste0(main_directory,"R - Processing data/output/Rdata/new_titles_agg_1940.fst"),as.data.table=TRUE)
...
for (i in c("sh_new_method1_dataset2","sh_new_method1_dataset3")) {
  ...
  county <- tm_shape(subset(map.countynhg_1910_more10000)) + tm_polygons(i,style = "pretty", n=10,lwd=0) +
    tm_shape(map.state) + tm_borders(alpha=0.1,lwd=0.5)
  tmap_save(county, paste0(main_directory,"R - Processing data/output/Maps/1940/",i,"_countynhg_1910_more10000.jpeg"))
  rm(county)
  ...
  county <- tm_shape(subset(map.countynhg_1910_more1000)) + tm_polygons(i,style = "pretty", n=10,lwd=0) +
    tm_shape(map.state) + tm_borders(alpha=0.1,lwd=0.5)
  tmap_save(county, paste0(main_directory,"R - Processing data/output/Maps/1940/",i,"_countynhg_1910_more1000.jpeg"))
  
  rm(county,map.countynhg_1910_more10000,map.countynhg_1910_more1000)
}
...
# Simplify ----
census_sample_1930_main <-
  census_sample_1930_main[,.(perwt=sum(perwt_ID),sh_red_tit=mean(sh_red_tit)),by=c("occind","countynhg_1910","lit","statefip","urban","male","lit","race","wwages","mig_us","mig_ab","age_main","ind1950","ind1950_main")]
...
cat(gsub(pattern = "\n", replacement = "  \n", 
         x = paste0(
           "Grouping by occind\n\n",
           "There are a total of ",length(census_sample_1930_occ_study$occind)," different occupations\n",
           "The mean of the New work variable was: ",
           format(round(mean(census_sample_1930_occ_study$sh_red_tit),4),nsmall=2),
           "\nand the standard deviation: ",
           format(round(sd(census_sample_1930_occ_study$sh_red_tit),4),nsmall=2),
           "\n\n"
         )
))

## Some graphs
ggplot(census_sample_1930_occ_study, aes(x=sh_red_tit)) +
        geom_histogram(color="black",bins=40,fill="white") +
        labs(title="Occupation Histogram for the Share of New Work",x="Share of New Work", y = "Number of Occupations")  + 
        theme_tufte() + theme(legend.position = "none")

ggplot(census_sample_1930_occ_study, aes(x=n_new_work)) +
        geom_histogram(color="black",bins=40,fill="white") +
        labs(title="",x="Occupation Histogram for the Number of New Workers", y = "Number of Occupations")  + 
        theme_tufte() + theme(legend.position = "none")

ggplot(census_sample_1930_occ_study[n_new_work<=300000], aes(x=n_new_work)) +
        geom_histogram(color="black",bins=40,fill="white") +
        labs(title="",x="Occupation Histogram for the Share of New Work (Occupations with less than 300.000 workers)", y = "Number of Occupations")  + 
        theme_tufte() + theme(legend.position = "none")

## Table
knitr::kable(census_sample_1930_occ_study[order(-sh_red_tit,-perwt),c("occind1930_name","occind","sh_red_tit","perwt","n_new_work")][1:15])
knitr::kable(census_sample_1930_occ_study[order(-sh_red_tit,-perwt),c("occind1930_name","occind","sh_red_tit","perwt","n_new_work")][16:30])

```
# TO-DO:  - Compute the mean and sd excluding workers in new sectors
