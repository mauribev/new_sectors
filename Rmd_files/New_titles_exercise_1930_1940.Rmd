...
temp <- A[,`:=`(
          ...
          ][ind1950 %in% c(376,377,466,556,606,667,668,816,856)][,`:=`(
                perwt=sum(perwt),
...
temp <- temp[,.SD[1],by="ind1950",.SDcols=names(temp[,!c("ind1950","countynhg_1910","occ","occ1950","occ1950_main","ind1950_main","statefip")])]
...
temp <- f_division(temp,c("perwt","N_countynhg_1910","N_statefip","N_occ","N_occ1950"),c(paste0(c("perwt","N_countynhg_1910","N_statefip","N_occ","N_occ1950"),"_nat")),c(paste0("sh_",c("perwt","N_countynhg_1910","N_statefip","N_occ","N_occ1950"))))
