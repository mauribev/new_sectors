...
census_sample_1930_countynhg_1910_data <-
  read_fst(here(paste0("output/Rdata/census_sample_1930_agg_countynhg_1910.fst")),as.data.table=TRUE,columns=c("countynhg_1910","perwt","sh_base","sh_base_tit","sh_base_titind","sh_red","sh_red_tit","sh_red_titind"))[perwt>=1000 & !is.na(countynhg_1910)]
...
census_sample_1930_individual_data <- read_fst(here(paste0("output/Rdata/census_sample_1930_individual_data.fst")),as.data.table=TRUE,columns=c("perwt_ID","countynhg_1910","occind","sh_red_tit"))
census_sample_1940_individual_data <- read_fst(here(paste0("output/Rdata/census_sample_1940_individual_data.fst")),as.data.table=TRUE,columns=c("perwt_ID","countynhg_1910","occ1940","name_ind1940_subgroup","sh_new_method1_dataset1","sh_new_method1_dataset2","sh_new_method1_dataset3"))
...
```{r}
#
census_sample_1930_grouped_occ <- census_sample_1930_individual_data[,.(perwt=sum(perwt_ID)),by=c("occind","sh_red_tit")]
census_sample_1940_grouped_occ_dt2 <- census_sample_1940_individual_data[,.(perwt=sum(perwt_ID)),by=c("occ1940","sh_new_method1_dataset2")][!is.na(sh_new_method1_dataset2)]
census_sample_1940_grouped_occ_dt3 <- census_sample_1940_individual_data[,.(perwt=sum(perwt_ID)),by=c("occ1940","sh_new_method1_dataset3")][!is.na(sh_new_method1_dataset3)]
...
Table <- data.table(
  ...
  '1930 - Individuals'=c(
                  nrow(census_sample_1930_individual_data),
                  format(round(mean(census_sample_1930_individual_data$sh_red_tit),4),nsmall=2),
                  format(round(sd(census_sample_1930_individual_data$sh_red_tit),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_individual_data$sh_red_tit)),4),nsmall=2)
  ),
  '1930 - Counties'=c(
                  nrow(census_sample_1930_countynhg_1910_data),
                  format(round(mean(census_sample_1930_countynhg_1910_data$sh_red_tit),4),nsmall=2),
                  format(round(sd(census_sample_1930_countynhg_1910_data$sh_red_tit),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1930_countynhg_1910_data$sh_red_tit)),4),nsmall=2)
  ),
  '1940 - Individuals - Dt2'=c(
                  nrow(census_sample_1940_individual_data),
                  format(round(mean(census_sample_1940_individual_data$sh_new_method1_dataset2,na.rm=TRUE),4),nsmall=2),
                  format(round(sd(census_sample_1940_individual_data$sh_new_method1_dataset2,na.rm=TRUE),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1940_individual_data$sh_new_method1_dataset2,na.rm=TRUE)),4),nsmall=2)
  ),
  '1940 - Counties - Dt2'=c(
                  nrow(census_sample_1940_countynhg_1910_data),
                  format(round(mean(census_sample_1940_countynhg_1910_data$sh_new_method1_dataset3,na.rm=TRUE),4),nsmall=2),
                  format(round(sd(census_sample_1940_countynhg_1910_data$sh_new_method1_dataset3,na.rm=TRUE),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1940_countynhg_1910_data$sh_new_method1_dataset3,na.rm=TRUE)),4),nsmall=2)
  ),
  '1940 - Individuals - Dt3'=c(
                  nrow(census_sample_1940_individual_data),
                  format(round(mean(census_sample_1940_individual_data$sh_new_method1_dataset3),4),nsmall=2),
                  format(round(sd(census_sample_1940_individual_data$sh_new_method1_dataset3),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1940_individual_data$sh_new_method1_dataset3,na.rm=TRUE)),4),nsmall=2)
  ),
  '1940 - Counties - Dt3'=c(
                  nrow(census_sample_1940_countynhg_1910_data),
                  format(round(mean(census_sample_1940_countynhg_1910_data$sh_new_method1_dataset3),4),nsmall=2),
                  format(round(sd(census_sample_1940_countynhg_1910_data$sh_new_method1_dataset3),4),nsmall=2),
                  format(round(unname(quantile(census_sample_1940_countynhg_1910_data$sh_new_method1_dataset3,na.rm=TRUE)),4),nsmall=2)
  )
)
```
...
g_1930_countynhg_1910 <-
  ggplot(census_sample_1930_countynhg_1910_data[,c("sh_red_tit")], aes(x=sh_red_tit)) +
...
g_1940_countynhg_1910_dt2 <-
  ggplot(census_sample_1940_countynhg_1910_data[,c("sh_new_method1_dataset2")], aes(x=sh_new_method1_dataset2)) +
        geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
...
g_1940_countynhg_1910_dt3 <-
  ggplot(census_sample_1940_countynhg_1910_data[,c("sh_new_method1_dataset3")], aes(x=sh_new_method1_dataset3)) +
        geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
...
# Individuals
g_1930_individuals <-
  ggplot(census_sample_1930_individual_data[,c("sh_red_tit")], aes(x=sh_red_tit)) +
        geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
...
g_1940_individuals_dt2 <-
  ggplot(census_sample_1940_individual_data[,c("sh_new_method1_dataset2")], aes(x=sh_new_method1_dataset2)) +
        geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
...
g_1940_individuals_dt3 <-
  ggplot(census_sample_1940_individual_data[,c("sh_new_method1_dataset3")], aes(x=sh_new_method1_dataset3)) +
        geom_histogram(color="black",bins=80,  aes(y = stat(width*density)),  fill="white") +
...
x_min <- -0.05 +min(
             min(census_sample_1930_individual_data[,c("sh_red_tit")]$sh_red_tit),
             min(census_sample_1940_individual_data[,c("sh_new_method1_dataset2")]$sh_new_method1_dataset2)
           )
x_max <- max(
             max(census_sample_1930_individual_data[,c("sh_red_tit")]$sh_red_tit),
             max(census_sample_1940_individual_data[,c("sh_new_method1_dataset2")]$sh_new_method1_dataset2)
           )
## Graph
ggarrange(
...
```{r}
A_1930 <- census_sample_1930_individual_data[,`:=`(mean=mean(sh_red_tit,na.rm=TRUE),q25=quantile(sh_red_tit,na.rm=TRUE)[2],q75=quantile(sh_red_tit,na.rm=TRUE)[4]),by="countynhg_1910"][,.SD[1],by="countynhg_1910",.SDcols=c("mean","q25","q75")]
A_1930 <- A_1930[order(mean,q75)][,order:=1:.N]

A_1940 <- census_sample_1940_individual_data[,`:=`(mean=mean(sh_new_method1_dataset2,na.rm=TRUE),q25=quantile(sh_new_method1_dataset2,na.rm=TRUE)[2],q75=quantile(sh_new_method1_dataset2,na.rm=TRUE)[4]),by="countynhg_1910"][,.SD[1],by="countynhg_1910",.SDcols=c("mean","q25","q75")]
A_1940 <- A_1940[order(mean,q75)][,order:=1:.N]


g_A_1930 <-
  ggplot(data=A_1930[order %in% floor(seq(1,2905,length=200))], aes(x=order)) +
    geom_line(aes(y=q75), color="blue") + geom_line(aes(y=q25), color="blue") +
    geom_line(aes(y=mean), color="red") + labs(title="",x="", y = "") +
      theme_tufte()

g_A_1940 <-
  ggplot(data=A_1940[order %in% floor(seq(1,2905,length=200))], aes(x=order)) +
    geom_line(aes(y=q75), color="blue") + geom_line(aes(y=q25), color="blue") +
    geom_line(aes(y=mean), color="red") + labs(title="",x="", y = "") +
      theme_tufte()
