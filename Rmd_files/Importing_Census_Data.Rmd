...
# 1940
 # Used to load year 1940. This one has geographical variables
    ddi <- read_ipums_ddi(paste0(main_directory,"R - Processing data/input/raw_data/usa_census_1940.xml"))
    ## From IPUMS names of variables are in uppercase letters. Change to lower case
    ddi$var_info$var_name <- tolower(ddi$var_info$var_name)
    census_sample_1940 <- as.data.table(read_ipums_micro(ddi))[,c("metaread","ownershpd","raced","bpld","mbpld","fbpld"):=NULL]
    
    write_fst(census_sample_1940,paste0(main_directory,"R - Processing data/input/census_sample/census_sample_1940.fst"))
#}
